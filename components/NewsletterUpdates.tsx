              ...
              <form className="w-full max-w-md">
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-transparent border-b border-white text-white py-4 text-sm font-body font-semibold uppercase tracking-wider placeholder-white/50 focus:outline-none focus:border-b-4 focus:border-white transition-all duration-200"
                    required
                  />
                  <button
                    type="submit"
                    className="absolute right-0 top-1/2 -translate-y-1/2 text-sm font-body font-semibold uppercase tracking-widest hover:text-white/70 transition-colors"
                  >
                    Submit
                  </button>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Link href="/music" className="group cursor-pointer">
              ...
              <div className="flex justify-between items-center text-xs font-body font-semibold uppercase tracking-widest text-white/50 mb-2">
                <span>Single</span>
                <span>1.23.2026</span>
              </div>
